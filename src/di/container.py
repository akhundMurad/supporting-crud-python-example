...
from src.di.factories import (
    build_attendance_data_create_service,
...
def get_container() -> Container:
    ...
    container.add_scoped_by_factory(build_attendance_data_create_service, AttendanceDataCreateService)
    container.add_scoped_by_factory(build_attendance_report_load_service, AttendanceReportLoadService)
